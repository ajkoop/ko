    ...
    return (
      <div className="App">
        ...
        <h2 class="mccsc">Director of Technology - MCCSC</h2>
         <p>I have worked for the Monroe County Community School Corporation for the past nine years and am proud to support student learning via custom data-driven technology solutions.</p>
