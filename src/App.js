  ...
  render() {
    return (
      <div className="App">
        ...
        <p>Today, I write data migration scripts for MCCSC using combinations of SQL and PowerShell and occasional bits of Python. I work on account synchronization for education and productivity companies. Here are a few:</p>
        <ul>
          <li>Canvas</li>
          <li>Google</li>
          <li>Microsoft</li>
