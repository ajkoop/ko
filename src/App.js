    ...
    return (
      <div className="App">
        ...
        <h2 class="mccsc">Director of Technology - MCCSC</h2>
         <p>I have worked for the Monroe County Community School Corporation for the past ten years and am proud to support student and staff safety and learning via custom data-driven technology solutions.</p>
