    ...
    return (
      <div className="App">
        ...
        <p className="App-intro">
          Hi, there. <img src={me} /></p> <p>I'm a creative and passionate executive leader with a 23 year career in Education spent writing, programming, teaching, and designing bent toward improving educational outcomes. </p>  <p>Here's what I'm up to professionally right now.</p>
